                ...
                <validator name="signinValidation">
                    <form class="signin-form form-horizontal" @submit.prevent="login($signinValidation)" novalidate>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password"
                                    ...
                                    class="from-control"
                                    :class="[$signinValidition.password.invalid?'ng-invalid':'ng-valid',$signinValidation.password.dirty?'ng-dirty':'']"
                                    placeholder="密码"
                                    >
                            </div>
                        </div>
                        ...
                        <div class="from-control">
                            <button class="btn btn-primary btn-lg btn-block" type="submit" id="signin_btn" :disabled="$signinValidation.invalid">
                                登录
                            </button>
                        </div>
                    </form>
